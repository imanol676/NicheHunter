...
async def expand_niche_to_sources(niche: str) -> dict:
    """
...
2. The JSON must have the following lists of strings: "reddit_communities", "hackernews_keywords", "youtube_search_queries".
...
"""
    ...
    try:
        ...
        if not reddit and not hn and not youtube:
